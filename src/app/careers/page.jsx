        ...
        <section className="relative pt-[60px]">
          <div className="relative h-[600px] md:h-[680px]">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-end pb-16 md:pb-20">
              ...
              >
                We are 22 people who genuinely love what we do — and we are
                always looking for talented people who share our obsession with
                craft.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-3 md:px-6 grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                ...
                and you want to work somewhere your taste and curiosity are
                valued — this might be the right place for you.
              </p>
              <blockquote
                className="pl-5 py-1"
